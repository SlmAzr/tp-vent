    ...
    <div class="container mx-auto p-6 bg-white rounded shadow-md">
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" class="w-full border-gray-300 rounded px-3 py-2"
            ...
            <button type="submit" class="text-blue-500  font-semibold px-4 py-2 rounded hover:bg-green-700">
                Mettre à jour
            </button>
        </form>
    </div>
